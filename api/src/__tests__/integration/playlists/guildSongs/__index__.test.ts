...
import { hasPermission, isGuildMember, hasRole, handleSearch } from '@@tests/support/mocks/index.js';
...
const extraParams: GuildSongExtraParams<GuildPlaylist> = {
    guildId: DISCORD.TESTING_SERVER_ID,
    mocks: { hasPermission, isGuildMember, hasRole, handleSearch }
};

describe("Guild Songs", () => {
