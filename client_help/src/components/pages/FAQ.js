...
class FAQ extends Component {
    ...
    render() {
        ...
        return(
            <div id="FAQ" className="app-page">
                <Helmet>
                    <title>FiresideBOT | FAQ</title>
                    <meta name="theme-color" content="#ff9900" />
                    <meta property="og:image" content="https://i.imgur.com/efYsW7T.png" />
                    <meta property="og:type" content="website" />
                    <meta property="og:title" content="FiresideBOT | FAQ" />
                ...
                <Row style={{ marginBottom: "5%" }}>
                    ...
                    <MDBCard style={{ background: "#1a1a1a", borderColor: "#3c3c3c" }}>
                        ...
                        <MDBCardBody className="FAQ-CardBody">
                            ...
                            <MDBBtn className="DiscordButton" size="sm" tag="a" target="_blank" rel="noopener noreferrer" href={this._inviteLink}>
                                Add to Discord
                            </MDBBtn>
                            <MDBBtn className="Button" size="sm" tag="a" target="_blank" rel="noopener noreferrer" href={this._helpLink}>Learn More</MDBBtn>
                        </MDBCardBody>
