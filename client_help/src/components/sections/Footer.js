            ...
            <div>
                ...
                <Container fluid className="text-center text-md-left" style={{ marginBottom: "2%" }}>
                    ...
                    <Col md="2" style={{ marginBottom: "2%" }}>
                        ...
                        <li className="list-unstyled Footer-LI">
                            <a className="Footer-Link" target="_blank" rel="noopener noreferrer" href="https://firesidebot.com/changelogs">Changelogs</a>
                        </li>
                        </ul>
                    </Col>
                    <Col md="2" style={{ marginBottom: "2%" }}>
                        ...
                        <ul className="Footer-UL" style={{ paddingLeft: "0" }}>
                        <li className="list-unstyled Footer-LI">
                            <a className="Footer-Link" target="_blank" rel="noopener noreferrer" href="https://discord.gg/TqKHVUa">Support Server</a>
                        </li>
                        <li className="list-unstyled Footer-LI">
