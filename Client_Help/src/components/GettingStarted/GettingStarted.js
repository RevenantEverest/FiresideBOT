            ...
            <div id="GettingStarted" style={{ marginTop: "2%", marginBottom: "5%" }}>
                ...
                <Row style={{ marginBottom: "10%" }}>
                    <Col>
                        ...
                        <br />
                        <MDBBtn color={Skin.MDBColor} className="mb-5 DiscordButton">
                    ...
                    <Col>
                        ...
                        <Row>
                            <Col lg={2} md={2}>
                                ...
                                <MDBBtn color={Skin.MDBColor} className="Button w-100">AddRank</MDBBtn>
                                </Link>
                            </Col>
                            <Col lg={2} md={4}>
                                <Link to="/commands/editrank">
                                <MDBBtn color={Skin.MDBColor} className="Button w-100">EditRank</MDBBtn>
                                </Link>
                            </Col>
                            <Col lg={2} md={4}>
                                <Link to="/commands/removerank">
                                <MDBBtn color={Skin.MDBColor} className="Button w-100">RemoveRank</MDBBtn>
                                </Link>
                            </Col>
                        </Row>
                        </Container>
                        ...
                        <MDBTable responsive>
                            ...
                            <MDBTableBody>
                                <tr>
                                    <td>Complexity</td>
                                    <td>20</td>
                                    <td><Link to="/command/editrankcomplexity" className="orange-text">EditRankComplexity</Link></td>
                                </tr>
                                <tr>
                                    <td>General Increase Rate</td>
                                    <td>10</td>
                                    <td><Link to="/command/editrankrate" className="orange-text">EditRankRate</Link></td>
                                </tr>
                                <tr>
                                    <td>Level Up Channel</td>
                                    <td>None</td>
                                    <td><Link to="/command/editrankchannel" className="orange-text">EditRankChannel</Link></td>
                                </tr>
                            </MDBTableBody>
                        </MDBTable>
                    </Col>
