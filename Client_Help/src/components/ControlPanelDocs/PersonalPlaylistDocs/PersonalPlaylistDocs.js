    ...
    return(
      <div id="PersonalPlaylistDocs">
        <div className="PersonalPlaylistDocs-Contents">
          <Link to="/controlpanel/personalplaylist"><h3 className="PersonalPlaylistDocs-Header">Personal Playlists</h3></Link>
          <p className="PersonalPlaylistDocs-SubHeader">Create your own playlists to be used in the </p>
          <Link to="/controlpanel/autodj">
          ...
          <Link to="/controlpanel/guildplaylists">
