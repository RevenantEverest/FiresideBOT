...
async function getTwitchTrackers(message, args, channel_id, role_id) {
    ...
    .then(tracker => {
        ...
        else updateTracker(message, args, channel_id, role_id, tracker);
    })
    .catch(err => {
...
async function updateTracker(message, args, channel_id, role_id, tracker) {
...
module.exports.run = async (PREFIX, message, args, server, bot, options) => {
    ...
    if(args.includes("-t")) getTwitchTrackers(message, args, channel_id, role_id);
