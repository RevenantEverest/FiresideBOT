...
class EditCustomCommand extends Component {
    ...
    handleSubmit(e) {
        ...
        if([].concat.apply([], this.state.defaultCommands.map(el => el.aliases)).includes(data.input.toLowerCase()))
            return;
        customCommandServices.update(data)
        .then(() => {
            ...
            <form onSubmit={this.handleSubmit}>
                ...
                <Row style={{ marginBottom: "5%" }}>
                    <Col lg={6} style={{ paddingLeft: 0, paddingRight: 0 }}>
                        ...
                        <Row>
                        <Col lg={10} id="EditCustomCommand-Input-Col">
                            <MDBInput 
                            name="input"
                            type="text" 
                            hint={this.props.customCommandData.input}
                    ...
                    <Col lg={6} style={{ paddingLeft: 0, paddingRight: 0 }}>
                        ...
                        <Row>
                        <Col lg={10} id="EditCustomCommand-Output-Col">
                            <MDBInput 
                            name="output"
                            type="text" 
                            hint={this.props.customCommandData.output}
                            onChange={this.handleChange} 
                            />
                        </Col>
                        </Row>
                ...
                <Row>
                    ...
                    <Col lg={3} md={3} sm={3} xs={3} style={{ paddingLeft: 0, paddingRight: 0 }}>
                        <MDBBtn color={Skin.hex} style={{ background: Skin.hex, margin: 0 }} size="md" onClick={this.handleSubmit}>Update</MDBBtn>
                    </Col>
                </Row>
                </Container>
            </form>
...
export default EditCustomCommand;